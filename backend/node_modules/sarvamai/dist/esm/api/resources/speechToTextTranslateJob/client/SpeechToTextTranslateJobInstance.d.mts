...
import type { SpeechToTextTranslateJobClient } from "./Client.mjs";
export declare class SpeechToTextTranslateJobInstance {
    private _jobId;
    private _client;
    constructor(jobId: string, client: SpeechToTextTranslateJobClient);
    /**
     ...
     */
    uploadFiles(filePaths: string[], _timeoutInSeconds?: number): Promise<boolean>;
    /**
     ...
     */
    waitUntilComplete(pollIntervalSeconds?: number, timeoutSeconds?: number): Promise<SarvamAI.JobStatusResponse>;
    /**
     ...
     */
    getStatus(): Promise<SarvamAI.JobStatusResponse>;
    /**
     * Start the speech-to-text-translate job processing.
     */
    start(): Promise<SarvamAI.JobStatusResponse>;
    /**

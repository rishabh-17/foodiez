...
import type { ChatCompletionChunk } from "../../../types/ChatCompletionChunk.mjs";
...
export declare class ChatClient {
     ...
     *     });
     */
    completions(request: SarvamAI.ChatCompletionsRequest & {
        stream: true;
    }, requestOptions?: ChatClient.RequestOptions): Promise<AsyncIterable<ChatCompletionChunk>>;
    completions(request: SarvamAI.ChatCompletionsRequest & {
        stream?: false | undefined;
    }, requestOptions?: ChatClient.RequestOptions): core.HttpResponsePromise<SarvamAI.CreateChatCompletionResponse>;
    completions(request: SarvamAI.ChatCompletionsRequest, requestOptions?: ChatClient.RequestOptions): core.HttpResponsePromise<SarvamAI.CreateChatCompletionResponse> | Promise<AsyncIterable<ChatCompletionChunk>>;
    private __completions;
    private __completionsStream;
    private _parseSSEStream;
    private _throwStatusCodeError;
}

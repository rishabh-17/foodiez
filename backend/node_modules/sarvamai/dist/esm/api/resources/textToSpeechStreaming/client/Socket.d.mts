...
export declare namespace TextToSpeechStreamingSocket {
    ...
    type Response = SarvamAI.AudioOutput | SarvamAI.EventResponse | SarvamAI.ErrorResponse;
    type EventHandlers = {
        open?: () => void;
...
export declare class TextToSpeechStreamingSocket {
     ...
     */
    configureConnection(config: SarvamAI.ConfigureConnection | {
        ...
        /** The ID of a pronunciation dictionary to apply during synthesis. Only supported by bulbul:v3. */
        dict_id?: string;
    }): void;
    ...
    protected sendJson(payload: SarvamAI.ConfigureConnection | SarvamAI.SendText | SarvamAI.FlushSignal | SarvamAI.PingSignal): void;
}

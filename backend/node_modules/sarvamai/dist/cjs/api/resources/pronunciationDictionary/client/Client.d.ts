...
export declare namespace PronunciationDictionaryClient {
    type Options = BaseClientOptions;
    interface RequestOptions extends BaseRequestOptions {
    }
}
export declare class PronunciationDictionaryClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<PronunciationDictionaryClient.Options>;
    constructor(options?: PronunciationDictionaryClient.Options);
    /**
     ...
     */
    list(requestOptions?: PronunciationDictionaryClient.RequestOptions): core.HttpResponsePromise<SarvamAI.PronunciationDictionaryGetResponse>;
    private __list;
    /**
     ...
     *     })
     */
    create(request: SarvamAI.CreatePronunciationDictionaryRequest, requestOptions?: PronunciationDictionaryClient.RequestOptions): core.HttpResponsePromise<SarvamAI.PronunciationDictionaryResponse>;
    private __create;
    /**
     ...
     *     })
     */
    update(request: SarvamAI.UpdatePronunciationDictionaryRequest, requestOptions?: PronunciationDictionaryClient.RequestOptions): core.HttpResponsePromise<SarvamAI.PronunciationDictionaryUpdateResponse>;
    private __update;
    /**
     ...
     *     })
     */
    delete(request: SarvamAI.PronunciationDictionaryDeleteRequest, requestOptions?: PronunciationDictionaryClient.RequestOptions): core.HttpResponsePromise<SarvamAI.PronunciationDictionaryDeleteResponse>;
    private __delete;
    /**
     ...
     */
    get(dict_id: string, requestOptions?: PronunciationDictionaryClient.RequestOptions): core.HttpResponsePromise<SarvamAI.PronunciationDictionaryData>;
    private __get;
}

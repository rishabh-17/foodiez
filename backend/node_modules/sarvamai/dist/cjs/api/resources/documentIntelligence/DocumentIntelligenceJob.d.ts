import type { DocumentIntelligenceClient } from "./client/Client.js";
import type * as SarvamAI from "../../index.js";
export interface DocumentIntelligenceJobOptions {
    ...
    callbackUrl?: string;
    /** Polling interval in milliseconds for waitUntilComplete (default: 2000) */
    pollingIntervalMs?: number;
    /** Maximum polling attempts for waitUntilComplete (default: 150 = 5 minutes at 2s intervals) */
...
export interface PageMetrics {
    ...
    pagesFailed: number;
    pageErrors: SarvamAI.DocDigitizationPageError[];
}
/**
 ...
 * ```
 */
export declare class DocumentIntelligenceJob {
    private _client;
    private _jobId;
    private _status;
    private _pollingIntervalMs;
    private _maxPollingAttempts;
    constructor(client: DocumentIntelligenceClient, jobId: string, options?: DocumentIntelligenceJobOptions);
    /** The unique job ID */
    get jobId(): string;
    /** Alias for jobId (Python SDK compatibility) */
    get job_id(): string;
    /** The last fetched status (may be null if not yet polled) */
    get status(): SarvamAI.DocDigitizationJobStatusResponse | null;
    /**
     * Upload a file to the job using a presigned URL.
     * Supports file path (Node.js) or File/Blob (browser).
     */
    uploadFile(file: string | File | Blob): Promise<void>;
    /**
     * Start processing the job.
     */
    start(): Promise<SarvamAI.DocDigitizationJobStatusResponse>;
    /**
     * Get the current status of the job.
     */
    getStatus(): Promise<SarvamAI.DocDigitizationJobStatusResponse>;
    /**
     * Poll until the job completes (Completed, PartiallyCompleted, or Failed).
     */
    waitUntilComplete(): Promise<SarvamAI.DocDigitizationJobStatusResponse>;
    /**
     ...
     */
    downloadOutput(outputPath: string): Promise<string>;
    /**
     * Get download links for the output files.
     */
    getDownloadLinks(): Promise<SarvamAI.DocDigitizationDownloadFilesResponse>;
    private _sleep;
}
